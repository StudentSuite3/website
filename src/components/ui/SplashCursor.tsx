'use client';
// Source: ReactBits "SplashCursor" (MIT). Fetched via the `components` skill
// (registry: https://reactbits.dev/r/SplashCursor-TS-TW) and adapted per the skill's
// adaptation rules: rainbow swapped for a brand PALETTE, a configurable wrapper class,
// and a prefers-reduced-motion guard (renders nothing when reduced motion is requested).
...
interface SplashCursorProps {
  ...
  COLOR?: string;
  /** Brand colors to splash (used when RAINBOW_MODE is false). Each splat picks one at random. */
  PALETTE?: string[];
  /** Container className. Defaults to a full-viewport, click-through background layer. */
...
export default function SplashCursor({
  ...
  COLOR = '#ff0000',
  PALETTE,
  WRAPPER_CLASS = 'fixed inset-0 z-0 pointer-events-none'
}: SplashCursorProps) {
